...
def get_KGE(dataset, use_cuda=True):
    if dataset == "UMLs":
        ...
        kge_dir = "KGE/RotatE/models/RotatE_wd15k_0"
        nentity = 15812
        nrelation = 179
        hidden_dim = 1000
        gamma = 9.0
    elif dataset == "ConceptNet":
        kge_dir = "KGE/RotatE/models/RotatE_cn100_3"
        nentity = 78339
        nrelation = 34
        hidden_dim = 1000
        gamma = 9.0
...
def kge_inference(kge_model, eval_arr, all_true_triple, nentity,nrelation,cpu_num,test_batch_size, use_cuda=True, tail_only=True):
    eval_triple = [tuple(row) for row in eval_arr]
    metrics, head_scores, head_preds, tail_scores, tail_preds = kge_model.test_step(kge_model, eval_triple, all_true_triple,nentity,nrelation,cpu_num,test_batch_size, use_cuda=use_cuda,tail_only=tail_only)
    return metrics, head_scores, head_preds, tail_scores, tail_preds